...
let containerHome = document.getElementById("homepage");
let containerAlbum = document.getElementById("albumplaylist");
...
async function renderApi(url) {
	const response = await fetch(urlApi + url, {
		method: "GET",
		headers: {
			"X-RapidAPI-Key": "02778350a1msha229d8a0a38ebb9p1b524ejsn81bdca4a05f9",//02778350a1msha229d8a0a38ebb9p1b524ejsn81bdca4a05f9   8bcbc2b046msh3dcbb714409d7fep1e2e85jsn9003429acc6f
...
function svuotaHome() {
	copiaHome = containerHome.cloneNode(true);
...
function homePage() {
	...
	containerHome.innerHTML = "";
	containerHome = copiaHome.cloneNode(true);
}
