let arrayArtisti=["fedez","eminem","queen","yuna","redwimps","system of a down","serj tankian"]
...
async function playlistPopola(){
    ...
    for(let i=0;i<cardPlaylist.length;i++){
        ...
        for(let i2=0;i2<4;i2++){
            ...
            cardPlaylist[i].innerHTML+=`<img src="${immagine.album.cover_small}" alt="" srcset="">`
...
function displayTracks(playlist) {
	...
	playlist.forEach((song) => {
     ...
     <div class="row my-3">
            ...
            <div class="col-3">
              <p onclick="cercaAlbum(${song.album.id})" class="h5">${song.album.title}</p>
            </div>
            <div class="col-3">
